        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <h3>Edit Produk</h3>
                <form action="{{route('produk.update', ['produk' => $produk->id])}}" id="form-create" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('patch')
                    <div class="widget-content widget-content-area br-6">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="nama-produk" type="text" name="nama_produk" value="{{$produk->nama_produk}}" class="form-control @error('nama_produk') is-invalid @enderror" >
                                @error('nama_produk')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="stock" type="text" name="stock" value="{{$produk->stock}}" class="form-control @error('stock') is-invalid @enderror">
                                @error('stock')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="inputHarga" type="text" name="harga" value="{{$produk->harga}}" class="form-control @error('harga') is-invalid @enderror">
                                @error('harga')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
